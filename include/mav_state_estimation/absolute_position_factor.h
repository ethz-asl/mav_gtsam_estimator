#ifndef FM_GTSAM_ESTIMATION_ABSOLUTE_POSITION_FACTOR_H_
#define FM_GTSAM_ESTIMATION_ABSOLUTE_POSITION_FACTOR_H_
...
#endif  // FM_GTSAM_ESTIMATION_ABSOLUTE_POSITION_FACTOR_H_
